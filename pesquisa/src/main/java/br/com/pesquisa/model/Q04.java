...
@Entity
public class Q04 implements Serializable, EntidadeBase{

	/**
	 * 
	 */
	private static final long serialVersionUID = -1367234508763767847L;

	public Q04() {

	}
	
	public Q04(int alternativa) {
		switch (alternativa) {
		case 1:
			alt1 = true;
			alt2 = false;
