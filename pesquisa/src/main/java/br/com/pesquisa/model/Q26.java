...
@Entity
public class Q26 implements Serializable, EntidadeBase{

	/**
	 * 
	 */
	private static final long serialVersionUID = -187397686763140023L;

	public Q26() {

	}

	public Q26(int alternativa) {
		switch (alternativa) {
		case 1:
			alt1 = true;
			alt2 = false;
	...
	private long id;
	private String descricao = "Assinale seu grau de satisfação em relação a salário.";
