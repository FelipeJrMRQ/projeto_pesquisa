...
@Entity
public class Q23 implements Serializable, EntidadeBase{

	/**
	 * 
	 */
	private static final long serialVersionUID = -6509008265630575851L;
	public Q23() {

	}

	public Q23(int alternativa) {
		switch (alternativa) {
		case 1:
			alt1 = true;
			alt2 = false;
	...
	private long id;
	private String descricao = " Assinale seu grau de satisfação em relação ao vale alimentação.";
